...
# Ensure these settings to access MYSQL database is correct!
DBpassword = ''  # for wamp it is default empty string
DBport = '3306'
DBusername = 'root'
DBhost = 'localhost'
DBname = 'ljms' #this should be fixed as our sql script creates a database with name ljms
